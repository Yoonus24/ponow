...
//               ),
//               Text(
//                 'Vendor: ${apinvoice.vendorName ?? 'Unknown Vendor'}',
//                 style: const TextStyle(
//                   fontWeight: FontWeight.bold,
//                   fontSize: 16,
//                 ),
...
//                           Expanded(
//                             flex: 2,
//                             child: _HeaderCell('Total Price', 0),
//                           ),
//                           Expanded(
//                             flex: 2,
//                             child: _HeaderCell('Final Price', 0),
//                           ),
//                         ],
//                       ),
//                     ),
...
//                     Column(
//                       children:
//                           apinvoice.itemDetails?.asMap().entries.map((entry) {
...
//                                   Expanded(
//                                     flex: 1,
//                                     child: _DataCell('${index + 1}', 0),
//                                   ),
//                                   Expanded(
//                                     flex: 3,
//                                     child: _DataCell(item.itemName ?? 'N/A', 0),
//                                   ),
//                                   Expanded(
//                                     flex: 2,
//                                     child: _DataCell(item.uom ?? 'N/A', 0),
//                                   ),
//                                   Expanded(
//                                     flex: 2,
//                                     child: _DataCell(
...
//                                     flex: 2,
//                                     child: _DataCell(
//                                       _formatNumber(item.stockQuantity),
//                                       0,
//                                     ),
//                                   ),
//                                   Expanded(
//                                     flex: 2,
//                                     child: _DataCell(
//                                       _formatNumber(item.befTaxDiscount),
//                                       0,
//                                     ),
//                                   ),
//                                   Expanded(
//                                     flex: 2,
//                                     child: _DataCell(
//                                       _formatNumber(item.afTaxDiscount),
//                                       0,
//                                     ),
//                                   ),
//                                   Expanded(
...
//                   children: [
//                     Text(
//                       'Discount: ${_formatCurrency(apinvoice.discountDetails)}',
...
//                     ),
//                     Text(
//                       'Total Invoice Amount: ${_formatCurrency(apinvoice.invoiceAmount)}',
//                       style: const TextStyle(
//                         fontSize: 14,
//                         fontWeight: FontWeight.bold,
//                       ),
