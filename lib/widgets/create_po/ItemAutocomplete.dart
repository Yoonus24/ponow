...
class _ItemAutocompleteState extends State<ItemAutocomplete> {
      ...
      child: Autocomplete<String>(
        ...
        onSelected: (selectedItemName) async {
          ...
          if (selectedItem != null) {
            debugPrint("✅ ITEM FOUND FROM CACHE");
            debugPrint("✅ ITEM CODE = ${selectedItem.itemCode}");
            ...
            try {
              ...
              debugPrint("✅ ITEM FOUND FROM API");
  ...
  void _updateItemDetailsDirectly(PurchaseItem item) {
    debugPrint("📍 SELECTED ITEM LOCATION ID: ${item.locationId}");
